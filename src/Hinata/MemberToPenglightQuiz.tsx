    ...
    <>
      {
        ...
        <>
          ...
          <>
            ...
            <br />
            <a className='share' href={`https://x.com/intent/post?text=☀️日向坂46ペンライトQUIZ☀️%0Aメンバー➔ペンライトカラーQUIZ【${category}】%0A%0A ${questionSum} 問中 ${questionSum-WAs.length} 問正解${WAs.length===0?'🎉':'！'}%0A&url=https://penlight-quiz.com/hinata&hashtags=日向坂46,ペンライトQUIZ`} target="_blank" rel="noreferrer noopener"><BsTwitterX size="17" /> 結果をシェア</a>
            {
              WAs.length !==0 &&
