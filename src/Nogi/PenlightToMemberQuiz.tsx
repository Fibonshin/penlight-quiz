    ...
    <>
      {
        ...
        <>
          ...
          <>
            ...
            <br />
            <a className='share' href={`https://twitter.com/intent/tweet?text=◢乃木坂46ペンライトQUIZ◢%0Aペンライトカラー➔メンバー4択QUIZ【${category}】%0A%0A ${questionSum} 問中 ${questionSum-WAs.length} 問正解${WAs.length===0?'🎉':'！'}%0A&url=https://penlight-quiz.com/nogi&hashtags=乃木坂46,ペンライトQUIZ`} target="_blank" rel="noreferrer noopener"><BsTwitterX size="17" /> 結果をシェア</a>
            {
              WAs.length !==0 &&
